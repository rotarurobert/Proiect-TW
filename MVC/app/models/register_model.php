...
class Regi{
    ...
    public static function insertUser($username, $password, $first_name, $last_name, $email, $telephone_number)
    {
          require_once '../app/core/DB.php';
          $database = DB::getConnection();
          $queryInsert = "INSERT INTO users(username, password, first_name, last_name, email, telephone_number) values(?,?,?,?,?,?)";
